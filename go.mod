...
require (
	...
	github.com/grafana/grafana-api-golang-client v0.13.1 // indirect
	...
	github.com/mikeshimura/goreport v0.0.0-20230106081721-d3e78b390dc5 // indirect
